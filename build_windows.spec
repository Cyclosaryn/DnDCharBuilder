...
"""
PyInstaller spec file for D&D Character Builder - WINDOWS BUILD

This file creates a Windows executable with splash screen support.
"""
...
exe = EXE(
    ...
    icon='DnDCharBuilder.ico',  # Windows icon
)
